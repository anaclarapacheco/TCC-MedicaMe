...
const getDecoratedClass = (tree, filePath, decoratorName, className) => {
    return exports.getDecoratedClasses(tree, filePath, decoratorName)
        .find((c) => !!(c.name && c.name.getText() === className));
};
exports.getDecoratedClass = getDecoratedClass;
const getDecoratedClasses = (tree, filePath, decoratorName) => {
...
exports.getDecoratedClasses = getDecoratedClasses;
const getDecoratorMetadataFromClass = (classNode, decoratorName) => {
...
exports.getDecoratorMetadataFromClass = getDecoratorMetadataFromClass;
...
const removeMetadataArrayValue = (tree, filePath, property, value) => {
...
exports.removeMetadataArrayValue = removeMetadataArrayValue;
const removeImport = (tree, filePath, importName) => {
    const source = exports.getSourceFile(tree, filePath);
...
const updateNodeText = (tree, node, newText) => {
...
const replaceTextInNode = (tree, node, oldText, newText) => {
...
exports.replaceTextInNode = replaceTextInNode;
